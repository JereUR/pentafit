...
export function HealthInfoForm({ healthInfo, userId, facilityId, onClose, primaryColor }: HealthInfoFormProps) {
  ...
  return (
    <div className="h-full flex flex-col border-r border-muted">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6 scrollbar-thin">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            {/* Additional Notes */}
            <div className="space-y-4 pt-4 pb-16 lg:pb-0 border-t">
      ...
      <div className="p-3 bg-background border-t sticky bottom-16 lg:bottom-0">
