...
import { useCreateNutritionalPlanMutation, useUpdateNutritionalPlanMutation } from "@/app/(main)/(authenticated)/(admin)/entrenamiento/planes-nutricionales/mutations"
